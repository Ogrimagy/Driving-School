					...
					try {
						if(isset($_POST["insert"])){  
							...
							if(mysqli_query($connect, $query)) {
								echo "<script>if(confirm(\" Votre photo de profile est modifier avec succées.\")){document.location.href='moniteur_code.php'};</script>";
							}
							...
							echo "<script>if(confirm(\" Opération reussite\")){document.location.href='moniteur_code.php'};</script>";
						}
