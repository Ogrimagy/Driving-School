    ...
    <center>
        <form id="formulaire" style="margin-left: 0%;" method="post" autocomplete="off">
            <table class="table" width="100%">
                    ...
                    <tr>
                        <td>
                            <select id="carType" name="carType" disabled="disabled">
                            	<?php
                            		$ty=$row['TypeV'];
                            	?>
                        ...
                        <td>
                            <select id="etat" name="etat" disabled="disabled">
                            	<?php
                            		$Et=$row['Etat'];
                            	?>
                    ...
                    <tr><td><div style="padding: 5%"></div></td></tr>
                    ...
                    <tr>
                        <th align="right">
                            <input class="btEffacer" type="reset" id="annuler" name="annuler" value="Annuler" onclick="window.location.href = 'gerant.php' ">
                        </th>
                        <th align="left">
