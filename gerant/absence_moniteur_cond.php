    ...
    <center>
        <div class="newpage">
            ...
            if(isset($_POST['mcond'])) {
                ...
                $requete2="SELECT * FROM `employee` WHERE id='$id_m'";
            ...
            <h1>Liste d'absence de <?php echo $nom_m; ?> <?php echo $prenom_m; }?></h1>
            <table class="modTable">
                <tr class="modRow" >
                    <th class="modTh">Date</th>
                </tr>
                <?php
                    $resultat=$connexion->query("SELECT * FROM `absence` WHERE Id_m='$id_m'");
