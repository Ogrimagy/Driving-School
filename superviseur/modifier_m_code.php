...
<?php
    ...
    if(isset($_POST['modifier_m_code'])) {
        $id_s=$_POST['id_s'];
                ...
                <table class="table" width="100%">
                    ...
                    <?php 
                        if(isset($_POST['modifier_m_code'])) {
                            ...
                            $resultat=$connexion->query("SELECT * FROM `employee` WHERE id='$id_code'");
                            while ($row=$resultat->fetch()) {
                    ?>

                    <tr><td colspan="2"><label id="title"><h2>Modification :: <?php echo ucfirst($dpNom) . " " . ucfirst($dpPre) ?> </h2></label>
                            <div class="typeMod">Role: <span class="vMod">Moniteur Code</span></div></td></tr>
                            <tr></tr><tr></tr>
                    ...
                    <tr>
                        <td>
                            <select id="etat" name="etat">
                                ...
                                <option value="3" selected>Moniteur de code</option>
                    ...
                    <?php
                            ...
                            if (isset($_POST['valider'])) {
                                ...
                                echo "<script>if(confirm(\"Votre moniteur de code: ".$nom." ".$prenom." est modifier avec succée.\")){document.location.href='superviseur.php'};</script>";
