...
<?php
    ...
    if(isset($_POST['historique_p'])) {

        $id=$_POST['id'];
        $requete1="SELECT * FROM `employee` WHERE id='$id'";
    ...
    <center>
        <div class="newpage">
            ...
            if(isset($_POST['historique_p'])) {
                ...
                $requete="SELECT * FROM `candidat` WHERE id_c='$id_c'";
            ...
            <h1>Liste paiement de <?php echo $nom_c; ?> <?php echo $prenom_c; }?></h1>
            <table class="modTable">
                <tr class="modRow" >
                    <th class="modTh">Montant</th>
                    <th class="modTh">Date de paiement</th>
                    <th class="modTh">Heure de paiement</th>
                </tr>
                <?php
                    $requete2="SELECT * FROM `paiement` WHERE id_c='$id_c'";
                    $resultat2=$connexion->query($requete2);
                    while($row=$resultat2->fetch()) {
                        $montant=$row['Montant'];
                        $date_p=$row['date_paiment'];
                        $hour=$row['heur'];
                ?>
                <tr class="modTr">
                    <td class="modTd"><?php echo $montant;?></td>
                    <td class="modTd"><?php echo $date_p;?></td>
                    <td class="modTd"><?php echo $hour;?></td>
